...
class ClinicAppointmentListWidget extends StatelessWidget {
  final DateTime selectedDate;
  final bool isDashboard; // [MỚI] Biến để xác định đang ở đâu

  const ClinicAppointmentListWidget({
    super.key, 
    required this.selectedDate,
    this.isDashboard = false, // Mặc định là false (cho tab Lịch)
  });
    ...
    return StreamBuilder<QuerySnapshot>(
      ...
      builder: (context, snapshot) {
        ...
        return ListView.builder(
          ...
          // --- [QUAN TRỌNG] FIX LỖI LAYOUT TẠI ĐÂY ---
          // Nếu là Dashboard -> co lại (shrinkWrap: true) và tắt cuộn
          // Nếu là Tab Lịch -> giãn ra (shrinkWrap: false) và cuộn bình thường
            ...
            return Card(
              ...
              child: ListTile(
                ...
                trailing: ElevatedButton(
                  ...
                  style: ElevatedButton.styleFrom(backgroundColor: isDone ? Colors.grey : Colors.teal),
